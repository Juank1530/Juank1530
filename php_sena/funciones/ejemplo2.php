...
<html>
    ...
    <body>
         ...
         * pero el argumento tiene un valor predefinido, asi que si el
         * usuario de la función no da un valor se generara una tabla con 3
     ...
     * predefinido 3 que será el npumero de filas de la tabla
     */
    imprimeTabla();
    /* Se llama la función poniendo como argumento 5 que serpa el número de
     * filas de la tabla
     */
    imprimeTabla(5);
    ?>
