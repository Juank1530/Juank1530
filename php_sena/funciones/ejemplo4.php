...
<html>
    ...
    <body>
        <?php
        /* En este programa se muestra como se pueden usar bibliotecas de
         * funciones creadas por el usuario, solo ahce falta recopilar
         ...
         * puesto que esta dentro de la misma carpeta se hace de la siguiente
         * manera
         */
         ...
         * la siguiente función hace todo eso, pero no esta dentro de este
