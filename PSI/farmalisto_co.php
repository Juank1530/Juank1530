...
$ok_ho=mysqli_stmt_bind_param($resulset_ho,"sssdddddddd", $u_negocio, $fecha, $home, $fcfp_de_ho, $fmfp_de_ho, $tti_de_ho, $ttbf_de_ho, $fcfp_mo_ho, $fmfp_mo_ho, $tti_mo_ho, $ttbf_mo_ho);
...
$ok_ca=mysqli_stmt_bind_param($resulset_ca,"sssdddddddd", $u_negocio, $fecha, $category, $fcfp_de_ca, $fmfp_de_ca, $tti_de_ca, $ttbf_de_ca, $fcfp_mo_ca, $fmfp_mo_ca, $tti_mo_ca, $ttbf_mo_ca);
...
$ok_pr=mysqli_stmt_bind_param($resulset_pr,"sssdddddddd", $u_negocio, $fecha, $product, $fcfp_de_pr, $fmfp_de_pr, $tti_de_pr, $ttbf_de_pr, $fcfp_mo_pr, $fmfp_mo_pr, $tti_mo_pr, $ttbf_mo_pr);
