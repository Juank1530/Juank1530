...
// $page_ho = $_GET['https://www.farmalisto.com.co/'];
// $page_ca = $_GET['https://www.farmalisto.com.co/2078-dermocosmetica'];
// $page_pr = $_GET['https://www.farmalisto.com.co/antisepticos/3401-comprar-agua-oxigenada-frasco-x-120-ml-precio-7702560000010.html'];
...
// $ttbf_de_ho = number_format(($data_de_ho . $ruta / 1000), 2);
$ttbf_de_ho = number_format(($data_de_ho["$lighthouseResult"]["$audits"]["$serverResponseTime"]["$numericValue"]/1000),2);

// $ttbf_de_ho = number_format(($data_de_ho["lighthouseResult"]["audits"]["server-response-time"]["numericValue"]/1000),2);
$ttbfdv_de_ho = $data_de_ho["lighthouseResult"]["audits"]["server-response-time"]["displayValue"];

$ttbf_mo_ho = number_format(($data_mo_ho["lighthouseResult"]["audits"]["server-response-time"]["$numericValue"] / 1000), 2);
$ttbfdv_mo_ho = $data_mo_ho["lighthouseResult"]["audits"]["server-response-time"]["displayValue"];
...
$ttbf_de_ca = number_format(($data_de_ca["lighthouseResult"]["audits"]["server-response-time"]["numericValue"] / 1000), 2);
$ttbfdv_de_ca = $data_de_ca["lighthouseResult"]["audits"]["server-response-time"]["displayValue"];

$ttbf_mo_ca = number_format(($data_mo_ca["lighthouseResult"]["audits"]["server-response-time"]["numericValue"] / 1000), 2);
$ttbfdv_mo_ca = $data_mo_ca["lighthouseResult"]["audits"]["server-response-time"]["displayValue"];
...
$ttbf_de_pr = number_format(($data_de_pr["lighthouseResult"]["audits"]["server-response-time"]["numericValue"] / 1000), 2);
$ttbfdv_de_pr = $data_de_pr["lighthouseResult"]["audits"]["server-response-time"]["displayValue"];

$ttbf_mo_pr = number_format(($data_mo_pr["lighthouseResult"]["audits"]["server-response-time"]["numericValue"] / 1000), 2);
$ttbfdv_mo_pr = $data_mo_pr["lighthouseResult"]["audits"]["server-response-time"]["displayValue"];
